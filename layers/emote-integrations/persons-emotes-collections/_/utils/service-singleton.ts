export const personsEmotesCollectionsService = new PersonsEmotesCollectionsService(
  new PersonsEmoteCollectionsIndexedDBRepository(
    ...
    new PersonsEmotesCollectionsIndexedDBTransactions(withEmoteIntegrationsIndexedDB),
  ),
