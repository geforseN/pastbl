import { SevenTVWrappedEmoteString } from "$/emote-integrations/foo/SevenTV/html";
...
export function getIntegrationContainer(target: HTMLImageElement) {
  return target.closest("[data-integration-source]");
}
