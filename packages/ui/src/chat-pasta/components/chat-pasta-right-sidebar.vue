...
<template>
  <div
    :class="[
      bem.element('right-sidebar'),
      twMerge('flex flex-col items-start justify-between gap-y-0.5 p-1', $attrs.class as string | undefined),
    ]"
    data-testid="chat-pasta-right-sidebar"
  >
